...
public class Config
{
    ...
    public static final ForgeConfigSpec.BooleanValue ALLOW_BOOK_COPYING = BUILDER
            .comment("Allow copying enchanted books to create duplicates")
            .define("allowBookCopying", true);

    public static final ForgeConfigSpec.BooleanValue ALLOW_GEAR_COPYING = BUILDER
            .comment("Allow copying enchantments directly from one gear item to another")
            .define("allowGearCopying", true);

    public static final ForgeConfigSpec.BooleanValue ALLOW_MOVE_ENCHANTMENTS_TO_BOOK = BUILDER
            .comment("Allow extracting enchantments from gear and storing them in books")
            .define("allowMoveEnchantmentsToBook", true);

    public static final ForgeConfigSpec.BooleanValue ALLOW_FIXED_REPAIR_COST = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue PREVENT_INCREASE_ENCHANTMENT_LEVEL = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue ALLOW_NONSTANDARD_REPAIRS = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue ALLOW_DECREASE_ENCHANTMENT_LEVEL = BUILDER
            .comment("Allow decreasing enchantment level on books using flint")
            .define("allowDecreaseEnchantmentLevel", true);

    public static final ForgeConfigSpec.BooleanValue ALLOW_HIGH_ANVIL_COST = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue FIXED_REPAIR_COST = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue MOVE_ENCHANTMENTS_TO_BOOK_COST = BUILDER
            .comment("XP cost (in levels) for moving enchantments from gear to book")
            .defineInRange("moveEnchantmentsToBookCost", 1, 1, 100);

    public static final ForgeConfigSpec.BooleanValue KEEP_ITEM_WHEN_MOVING_ENCHANTMENTS_TO_BOOK = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue DECREASE_ENCHANTMENT_LEVEL_COST = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue GEAR_COPYING_COST = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue MAX_BOOK_COPIES = BUILDER
